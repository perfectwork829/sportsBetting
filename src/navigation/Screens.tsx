...
import {Articles, Components, Home, Profile, Register, Pro, Dashboard, newBets, activeBets, betDetail, tabsBets, tabDetail, settledBets, setDetail, IRC, giveAways, Customers} from '../screens';
